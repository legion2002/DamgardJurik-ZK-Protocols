...
def prover_commitment(v1 : int, v2: int):
    ...
    return u1, u2, a1, a2, r1, r2, e2,z2

def prover_generates_proof(s, e2, r1, v1):
...
def verifier_generates_s():
    return verifier_generates_e()
...
def test_zk_system():
    ...
    u1, u2, a1, a2, r1, r2, e2,z2 = prover_commitment(v1,v2)

    s = verifier_generates_s()
    e1,  z1 = prover_generates_proof(s, e2, r1, v1 )
